...
export const receiptService = {
  ...
  generateOfficialPDF(order, storeInfo = {}) {
    ...
    const storeTin = storeInfo.tin || 'TIN: 987-654-321-00000';
    ...
    // Primary Colors
    doc.setFillColor(180, 20, 20); // Red Accent
    ...
    doc.text('Thank you for your business! Official Electronic Invoice generated by MKC Foods Corporation.', 105, y, { align: 'center' });

    doc.save(`MKC-Official-Invoice-${orderNum}.pdf`);
  },
  ...
  printThermalPOS(order, storeInfo = {}) {
    ...
    const html = `
      ...
      <html>
      <head>
        <title>MKC POS Receipt #${orderNum}</title>
        <style>
      ...
      <body>
        ...
        <div class="text-center" style="font-size: 9px; margin-top: 4px;">MKC Foods Corporation Platform</div>
        <script>
