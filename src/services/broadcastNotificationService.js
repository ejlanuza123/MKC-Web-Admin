...
export const PRESET_TEMPLATES = [
  {
    ...
    message: 'Enjoy 15% off all MKC Platters and Bundles from 5:00 PM to 8:00 PM today! Order now via the mobile app.'
  },
  {
    id: 'rain_advisory',
    ...
    message: 'Deliveries may be delayed by 10–15 mins due to localized rainfall for rider safety. Thank you for your patience!'
  },
  {
    id: 'chef_special',
    category: 'promo',
    targetAudience: 'customers',
    title: '🍲 Fresh Hot Meals Ready!',
    message: 'Check out today\'s chef specials and hot rice meal bundles. Fast delivery straight to your doorstep.'
  },
  {
    ...
    message: 'Order volume is peaking right now! Go online to claim high-priority delivery incentives.'
  },
  {
    id: 'holiday_schedule',
    category: 'emergency',
    ...
    message: 'Our kitchen will observe adjusted holiday hours today and close at 6:00 PM. Please schedule orders early!'
  }
];
