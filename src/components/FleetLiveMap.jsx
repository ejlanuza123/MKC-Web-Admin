...
export default function FleetLiveMap({ isDarkMode: isDarkModeProp, onSelectOrder }) {
  ...
  const mapHtml = useMemo(() => {
    const defaultCenter = { lat: 9.7395476, lng: 118.7407811 }; // MKC Foods Corporation Hub

    // Store origin
    const storePin = { lat: 9.7395476, lng: 118.7407811, name: 'MKC Foods Corporation Hub' };
