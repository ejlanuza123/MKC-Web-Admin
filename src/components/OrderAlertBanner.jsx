...
export default function OrderAlertBanner({ storeName = "MKC Foods Corporation" }) {
  ...
  useEffect(() => {
    const channel = supabase
      .channel('realtime-new-orders-banner-mkc')
      .on(
        'postgres_changes',
        {
          event: 'INSERT',
        ...
        (payload) => {
          ...
          console.log('🔔 Real-Time Order Received on MKC Admin Dashboard:', newOrder);
