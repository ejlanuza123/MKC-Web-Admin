    ...
    <div className="space-y-6">
      ...
      <div className={`p-4 rounded-xl border flex flex-wrap items-center justify-between gap-3 ${isDarkMode ? 'bg-slate-800/60 border-slate-700' : 'bg-blue-50/60 border-blue-100'}`}>
        <div className="flex items-center gap-2">
          <Zap size={18} className="text-mkc-blue" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div className={`p-4 rounded-xl border transition-colors duration-300 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-white border-gray-200 shadow-sm'}`}>
          <div className="flex justify-between items-start mb-2">
            ...
            <div className="p-2 rounded-lg bg-blue-100 dark:bg-slate-800 text-mkc-blue">
              <DollarSign size={16} />
            </div>
          </div>
          <p className="text-xl font-bold text-mkc-blue">{formatCurrency(stats.periodRevenue)}</p>
        ...
        <div className={`p-4 rounded-xl border transition-colors duration-300 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-white border-gray-200 shadow-sm'}`}>
          <div className="flex justify-between items-start mb-2">
            <span className={`text-xs font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Active Riders</span>
            <div className="p-2 rounded-lg bg-emerald-100 dark:bg-slate-800 text-emerald-600">
              <Truck size={16} />
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className={`p-6 rounded-xl border transition-colors duration-300 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-white border-gray-200 shadow-sm'}`}>
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/riders" className="text-xs text-mkc-blue hover:underline font-semibold flex items-center gap-1">
        ...
        <div className={`p-6 rounded-xl border transition-colors duration-300 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-white border-gray-200 shadow-sm'}`}>
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              <MessageSquare size={18} className="text-mkc-blue" />
              <h3 className={`font-bold text-base ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Customer Feedback</h3>
            </div>
            <Link to="/reviews" className="text-xs text-mkc-blue hover:underline font-semibold flex items-center gap-1">
              View All <ArrowRight size={12} />
            </Link>
          </div>
      ...
      <div className={`p-6 rounded-xl border transition-colors duration-300 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-white border-gray-200 shadow-sm'}`}>
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-2">
            <ShoppingBag size={18} className="text-mkc-blue" />
            <h3 className={`font-bold text-base ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Recent Orders</h3>
          </div>
          <Link to="/orders" className="text-xs text-mkc-blue hover:underline font-semibold flex items-center gap-1">
              ...
              <tbody>
                {recentOrders.map((order) => (
                  <tr key={order.id} className={`border-b ${isDarkMode ? 'border-slate-700/50 hover:bg-slate-800' : 'border-gray-50 hover:bg-gray-50'}`}>
                    <td className="py-3 px-3 font-semibold text-mkc-blue">#{String(order.id || '').slice(0, 8)}</td>
