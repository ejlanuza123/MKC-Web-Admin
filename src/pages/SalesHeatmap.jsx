  ...
  const handleExport = async (format) => {
    ...
    try {
      if (format === 'csv') {
        ...
        sheet.addRow(['MKC FOODS CORPORATION - PUERTO PRINCESA CITY GEOGRAPHIC SALES DENSITY REPORT']);
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className={`text-sm mt-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Thermographic visualizer of food delivery order density, high-revenue corridors, and barangay market penetration in Puerto Princesa City.
          </p>
        </div>
