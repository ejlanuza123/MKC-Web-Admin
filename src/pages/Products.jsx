...
import { Plus, Edit2, Trash2, Package, AlertTriangle, ImageOff, Settings, Bell, RefreshCw, Zap } from 'lucide-react';
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className={`px-3 py-2 rounded-lg border text-xs font-semibold flex items-center gap-1.5 transition ${
              isDarkMode ? 'border-slate-700 bg-slate-800 text-slate-300 hover:bg-slate-700' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'
            }`}
          ...
          <button 
            onClick={openAdd}
            className="bg-blue-600 text-white px-5 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-colors duration-150 shadow-md text-sm font-semibold"
          >
            <Plus size={18} />
            Add New Product
          </button>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <select
          ...
          className={`border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-600 outline-none transition-colors duration-300 text-sm ${isDarkMode ? 'bg-slate-800 border-slate-700 text-white' : 'bg-white border-gray-300 text-gray-900'}`}
        >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        >
          <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Low Stock (&le;{lowStockThreshold})</p>
        ...
        >
          <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Out of Stock</p>
          <p className="text-2xl font-bold text-red-600">{stats.outOfStock}</p>
        </div>
        <div className={`p-4 rounded-lg border min-w-0 transition-colors duration-300 ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'}`}>
          <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Categories</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    {product.description && (
                      <p className={`text-sm mb-2 line-clamp-2 transition-colors duration-300 ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>{product.description}</p>
                    )}
                    ...
                    <div className="flex justify-between items-center mt-3">
                      ...
                      <div className="text-right">
                        <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-gray-400'}`}>Stock</p>
                    ...
                    <div className="mt-4 pt-3 border-t flex gap-2">
                      ...
                      <button 
                        ...
                        className={`flex-1 py-2 rounded-lg text-xs font-medium flex items-center justify-center gap-1 transition-colors ${isDarkMode ? 'bg-slate-700 text-slate-300 hover:bg-slate-600' : 'bg-gray-100 text-gray-700 hover:bg-blue-50 hover:text-blue-600'}`}
                      >
                        <Edit2 size={13} />
                        Edit
                      </button>
                      <button 
                        ...
                        className={`px-3 rounded-lg flex items-center justify-center transition-colors ${isDarkMode ? 'bg-red-900/30 text-red-400 hover:bg-red-900/50' : 'bg-red-50 text-red-600 hover:bg-red-100'}`}
                      >
                        <Trash2 size={13} />
                      </button>
                    </div>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <div className={`${isDarkMode ? 'bg-slate-800' : 'bg-white'} rounded-xl w-full max-w-md shadow-2xl transition-colors duration-300`}>
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className={`block text-xs font-semibold mb-1 ${isDarkMode ? 'text-slate-300' : 'text-gray-700'}`}>Threshold (Units)</label>
                <input
                  type="number"
                  min="1"
                  max="500"
                  ...
                  className={`w-full border rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-600 outline-none ${
            ...
            <div className={`p-6 border-t flex gap-3 justify-end ${isDarkMode ? 'bg-slate-700/50 border-slate-600' : 'bg-gray-50 border-gray-200'}`}>
              <button
                ...
                className={`px-4 py-2 border rounded-lg text-sm font-medium ${isDarkMode ? 'border-slate-600 text-slate-300 hover:bg-slate-600' : 'border-gray-300 text-gray-700 hover:bg-gray-100'}`}
              >
                Cancel
              </button>
              <button
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <div className={`${isDarkMode ? 'bg-slate-800' : 'bg-white'} rounded-xl w-full max-w-md shadow-2xl transition-colors duration-300`}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className={`block text-xs font-semibold mb-1 ${isDarkMode ? 'text-slate-300' : 'text-gray-700'}`}>Add Quantity to Stock</label>
                    ...
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-lg border text-xs font-bold transition ${
                        restockAmount === String(qty)
                          ...
                          : isDarkMode ? 'border-slate-600 text-slate-300 hover:bg-slate-700' : 'border-gray-300 text-gray-700 hover:bg-gray-100'
                      }`}
                    >
                      +{qty}
                    </button>
